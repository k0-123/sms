...
class HistoryScreen(QWidget):
    def __init__(self, engine=None, parent=None):
        ...
        header = QVBoxLayout()
        header.setSpacing(2)
        title = QLabel("Dispatch Logs & Telemetry")
        title.setStyleSheet("font-size: 24px; font-weight: 700; color: #ffffff; letter-spacing: -0.5px;")
        subtitle = QLabel("AUDIT LOGS • EXPORT CSV/EXCEL • RETRY FAILED TRANSMISSIONS")
        ...
        # Campaigns Table
        camp_lbl = QLabel("CAMPAIGN MANIFESTS:")
        ...
        self.export_btn = QPushButton("[ 📥 EXPORT_AUDIT_LOG ]")
        self.retry_failed_btn = QPushButton("[ 🔄 RETRY_FAILED_PACKETS ]")
        self.retry_failed_btn.setStyleSheet("background-color: #18181b; border: 1px solid #00e599; color: #00e599; font-weight: 700;")
